...
for {j in Macchine}
{
  ...
  printf "; Impiego Complessivo: %g\n", sum{i in Progetti} x[i,j]*lunpro[i];
}

data;

set Progetti := p1 p2 p3 p4 p5 p6 p7 p8 p9 p10 p11 p12 p13 p14 p15 p16;
set Macchine := m1 m2 m3 m4;

param lunpro:=p1 3 p2 4 p3 4 p4 5 p5 5 p6 6 p7 8 p8 9 p9 7 p10 5 p11 6 p12 8 p13 8 p14 2 p15 10 p16 9;
